 ...
 *Fig. 2:* Madelbrot Set Convergence   
...
**z₀ = 0** and testing whether for some complex number **c = x + iy** the sequence **zᵢ₊ᵢ = zᵢ² + c** is bounded, we
switch the roles a bit. We fix the value for **c**, we set an arbitrary initial condition **z₀ = x + iy**, and we
